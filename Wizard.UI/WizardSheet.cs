...
namespace Wizard.UI
{
    ...
    public class WizardSheet : System.Windows.Forms.Form
    {
        ...
        protected void SetActivePage(string newPageName)
        {
        ...
        {
            EnableButton(WizardButtons.Next, false);
        ...
        {
            EnableButton(WizardButtons.Back, false);
            WizardPageEventArgs wpea = PreChangePage(-1);
        ...
        {
            EnableButton(WizardButtons.Finish, false);
